			...
			<div>
				...
				<div>
					<div className="container text-right">
						<button
							className={this.state.fridgeView === true ? 'btn btn-primary mr-1' : 'btn btn-default mr-1'}
							onClick={() => this.changeList(true)}
						>
							Fridge
						</button>
						<button
							className={this.state.fridgeView ? 'btn btn-default mr-1' : 'btn btn-primary mr-1'}
							onClick={() => this.changeList(false)}
						>
							Freezer
						</button>
					</div>
					<div>
						{this.state.fridgeView ? (
							<FridgeList
								fridgeFreezerList={this.state.fridgeFreezerList}
								removeItem={(event, i) => this.removeItem(event, i)}
							/>
						) : (
							<FreezerList
								fridgeFreezerList={this.state.fridgeFreezerList}
